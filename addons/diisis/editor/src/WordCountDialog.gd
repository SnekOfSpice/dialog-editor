...
func _on_about_to_popup() -> void:
	dialog_text = str(
		...
		"Word Count on page (approx): ", Pages.get_word_count_on_page_approx(Pages.editor.current_page.number), "\n",
		"Character Count on page (approx): ", Pages.get_character_count_on_page_approx(Pages.editor.current_page.number), "\n\n",
