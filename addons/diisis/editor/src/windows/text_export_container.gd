...
func init():
	...
	%IncludeIDsCheckBox.button_pressed = Pages.preferences_export.get("include_ids", true)
...
func update_warnings() -> void:
	%IDWarningLabel.visible = not %IncludeIDsCheckBox.button_pressed # Replace with function body.
...
func get_preferences() -> Dictionary:
	return {
		...
		"include_ids" : %IncludeIDsCheckBox.button_pressed,
